...
public class AutoSwitchController {
	...
	public String dagrunning_page(HttpServletRequest request, HttpSession session) {
		...
		case "pprc_go_simu":
			...
			break;
		case "pprc_back_simu":
			link = "zbswitch/instance_autoswitch_pprc_back_simu_running";
			break;
		default:
			link = null;
		}
	...
	public String daghistoryPage(@RequestParam Map<String, String> dag, Model model) {
		...
		case "pprc_back":
			...
			break;
		case "pprc_go_simu":
			link = "zbswitch/instance_autoswitch_pprc_go_simu_history";
			break;
		case "pprc_back_simu":
			link = "zbswitch/instance_autoswitch_pprc_back_simu_history";
			break;
		default:
			break;
		}
