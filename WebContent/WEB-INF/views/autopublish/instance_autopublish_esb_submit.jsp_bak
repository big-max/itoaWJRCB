...
<body>
	...
	<div class="content">
		...
		<div class="easyui-layout" style="width:99.8%;height:95%;margin:0 auto;">
			<div data-options="region:'west'" title="步骤2：应用信息" style="width:30%;padding:10px">
				<div class="divbott">
					<div class="inptext">
						<label>变更系统:&nbsp;&nbsp;&nbsp;</label>
					</div>
				...
				<div style="margin-top:60px;">
					<div style="float:left;width:38%;margin-left:50px;">
						<a id="pre" href="#" class="easyui-linkbutton" onclick="javascript:history.go(-1);" style="padding:5px 0px;width:100%;">
							<span style="font-size:14px;">上一步</span>
						</a>
					</div>
					<div style="float:right;width:38%;margin-right:20px;">
						<a id="submit" href="#" class="easyui-linkbutton" onclick="Submits()" style="padding:5px 0px;width:100%;">
