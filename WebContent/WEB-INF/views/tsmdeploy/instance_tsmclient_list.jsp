						...
						var  out=[];
					  	...
					  	swal({title: "",text:finalStringOut ,  type: type,confirmButtonText: "返回",confirmButtonColor: "rgb(174,222,244)"},
								function(isConfirm)
								{
									  if (isConfirm) 
									  {
										  window.location.href = "getIBMAllInstance.do?ptype=tsmclient";
									  } 
								})
					}
...
<body>
	...
	<div class="content">
		<div class="breadcrumb">
			...
			<a href="#" class="current1" style="position:relative;top:-3px;">IBM TSM</a>
		</div>
			...
			<div class="row-fluid">
				<div class="span12">
					...
					<div class="columnfoot" style="width: 93%; left: 5%;">
						<a class="btn btn-info fr btn-next" onclick="checkTSMSelect();">
