								...
								<tbody class="searchable">
									<c:forEach items="${securitytemplate }" var="setmp" varStatus="status">
										<tr>
											...
											<td style="text-align: center;"><a href="" id="modeldetail" style="color:#08c;">详情</a></td>
										</tr>
									</c:forEach> 
									<!-- <tr>
										<td style="text-align: center;">1</td>
									    <td style="text-align: center;">Template1</td>								
										<td style="text-align: center;">2017-06-21 12:50:05</td>
										<td style="text-align: center;">root</td>
										<td style="text-align: center;"><span id="temp2" style="color:#08c;" onclick="temp2()">详情</span></td>
									</tr> -->
								</tbody>
							</table>
...
<script>
	...
	function CheckInputModel()
	{
		 ...
		 var fileoscheck = $("#fileoscheck").text();
		 var uid = $("#uid").text();
		 var group = $("#group").text();
		 var gid = $("#gid").text();
		 var home = $("#home").text();
		 var ftplogin = $("#ftplogin").text();
		 var timeout = $("#timeout").text();
		 var setumask = $("#setumask").text();
		 var maxopenfile = $("#maxopenfile").text(); */
		 var radioVal = "";
		 ...
		 {
			 radioVal = "yes";
			 var datas = {"newkey":param,"newvalue":param_value};
			 $.ajax({
				 url:'<%=path%>/addItem.do',
					type:'post',
					dataType : 'json',
